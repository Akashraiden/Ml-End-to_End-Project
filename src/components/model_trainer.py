...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # Define parameters (example hyperparameters, adjust as needed)
            param = {
                "Random Forest": {"n_estimators": [50, 100]},
                "Decision Tree": {"max_depth": [3, 5, None]},
                "Gradient Boosting": {"learning_rate": [0.01, 0.1]},
                "Linear Regression": {},
                "XGBRegressor": {"learning_rate": [0.01, 0.1]},
                "CatBoosting Regressor": {"depth": [6, 8]},
            ...
            model_report: dict = evaluate_models(
                ...
                y_test=y_test,
                models=models,
                param=param,  # Pass the param argument
            )
